// ==UserScript==
// @name         Wankle3D Cheat v27-mag045 — v25-opt base + v26 features (prediction engine, magnetize fix, randomized safe-dir) properly ported onto slim+perf-optimized base
  ...
  net[_sendName || 'sendInput'] = function(input) {
    try {
      ...
      if (cfg.autoDodge && lastDodgeVec && !proposal.moveOverride) {
        ...
        if (dUrg > 0.45) {  // v27-mag045 variant: threshold raised from 0.35 to 0.45
