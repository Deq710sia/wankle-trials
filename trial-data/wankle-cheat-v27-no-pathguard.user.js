// ==UserScript==
// @name         Wankle3D Cheat v27-no-pathguard — v25-opt base + v26 features (prediction engine, magnetize fix, randomized safe-dir) properly ported onto slim+perf-optimized base
...
function boot(WANKLE, discovered) {
  ...
  function computeDodge() {
    ...
    // v27-no-pathguard: DISABLED — force crossCount to 0 so guard never triggers
    crossCount = 0;
    if (crossCount > 0) {
