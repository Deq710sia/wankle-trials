// ==UserScript==
// @name         Wankle3D Cheat v22.0 — Velocity-Aware Dodge + Binary-Search Bank Scan
// @namespace    wankle-cheat
// @version      22.0.0
// @description  v22.0: velocity-aware dodge (dot product between shell vector and tank velocity — fixes moving-toward-bullets) + binary-search bank-shot scan (faster than linear 360° sweep). `=diag F8=toggle F9=menu 1-5=profiles.
...
function boot(WANKLE, discovered) {
  ...
  console.log('%c[wkl v22.0] Ready. Velocity-aware dodge + binary bank scan. Profiles: 1=Rage 2=Legit 3=Safe 4=Ghost 5=ESP.', 'color:#7fd0ff;font-weight:bold');
}
