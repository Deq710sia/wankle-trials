...
(function(){
  try {
    ...
    // v25: path-segment guard telemetry (separate from cold-spot guardViolated)
    ...
    if (!me || me.dead) {
      ...
      if (now - pb.respawnT > 200) { WANKLE.input.fire = true; pb.respawnT = now; }
      else if (now - pb.respawnT > 100) { WANKLE.input.fire = false; }
      return;
    }
