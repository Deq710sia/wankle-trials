...
set -u
LOG_DIR="${PARALLEL_LOG_DIR:-/home/z/my-project/scripts/cheat-tests/parallel-logs}"
TRIAL_LOG_DIR="${PARALLEL_JSONL_DIR:-/home/z/my-project/scripts/cheat-tests/parallel-trial-logs}"
...
RESULTS_CSV="${PARALLEL_CSV:-/home/z/my-project/scripts/cheat-tests/parallel-results.csv}"
...
ab() { agent-browser --session ${PARALLEL_SESSION:-default} "$@" 2>&1; }
